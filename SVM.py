...
train_data_dir = r'./RGB_Augmented/Train_images'
test_data_dir = r'./RGB_Augmented/Test_Images'
train_annotations_file = r'./RGB_Augmented/Train_Labels_CSV.csv'
test_annotations_file = r'./RGB_Augmented/Test_Labels_CSV.csv'
